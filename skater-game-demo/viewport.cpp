...
Viewport::Viewport() : 
  ...
  position(0, 0),
  hudLoc(Gamedata::getInstance().getXmlInt("hud/x"),
...
void Viewport::draw() const 
{
  ...
  IOmod::getInstance().
    writeText("Tracking "+objectToTrack->getName(), black, hudLoc[0]+20, hudLoc[1]+20);
    
  //On Screen Title
  // IOmod::getInstance().
  //   writeText(Gamedata::getInstance().getXmlStr("screenTitle"), 
  //     Gamedata::getInstance().getXmlInt("view/width")/2+30,
  //       30);
}
